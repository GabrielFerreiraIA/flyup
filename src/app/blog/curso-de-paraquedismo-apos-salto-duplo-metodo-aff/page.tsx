...
export const metadata = {
    title: "Curso de Paraquedismo após Salto Duplo: Entenda o Método AFF | Flyup",
            ...
            <section className="py-24">
                <div className="container mx-auto px-6 max-w-3xl">
                    ...
                    <div className="mt-20 pt-12 border-t border-zinc-200 text-center bg-zinc-50 rounded-3xl p-10 shadow-sm border border-zinc-100">
                        ...
                        <p className="text-zinc-500 font-medium mb-10 max-w-lg mx-auto">Toda jornada de mil milhas começa nos livros de chão da Flyup até a queda de cabeça nas alturas do certificado!</p>
