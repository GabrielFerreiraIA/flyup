...
export const metadata = {
    title: "Qual a sensação de saltar de paraquedas pela primeira vez? | Flyup",
                ...
                <div className="container mx-auto px-6 max-w-3xl">
                    ...
                    <article className="prose prose-lg max-w-none">
                        ...
                        <p className="text-lg text-zinc-600 leading-loose mb-10">
                            Para você entender profundamente essa mágica (antes mesmo de fazer as suas malas rumo a Flyup em Boituva), vamos detalhar cuidadosamente todas as etapas mentais e físicas! E fique tranquilo, mesmo quem sofre de fobia de montanha-russa consegue amar a queda livre. Vamos descobrir o motivo?
                        </p>
